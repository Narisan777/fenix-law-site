...
const translations = {
    ru: {
        ...
        session_title: 'Стратегическая сессия — $150',
        ...
        about_name: 'Нариман Исанов',
        about_role: 'Основатель и главный партнёр Fenix Law',
        ...
        stat3_sub: 'внешнее юридическое сопровождение',
    ...
    en: {
        ...
        session_title: 'Strategic Session — $150',
        ...
        audit_price_pill: 'Express review — from $1,000 · Full audit across all blocks — from $2,500',
        ...
        about_name: 'Nariman Issanov',
        about_role: 'Founder & Managing Partner, Fenix Law',
        ...
        stat3_sub: 'full external legal support',
        ...
        faq4_a: 'The express review (from $1,000) covers a limited scope — for example, the product block: Terms, Privacy, consent mechanisms — and takes up to a week. The full audit covers all blocks: product, corporate structure, intellectual property, team, growth readiness, plus a separate Astana Hub compliance module for participants. The format is tailored to your situation.',
